...
const PostSection = () => {
    ...
    const data: BoxItem[] = [
        ...
        { id: '8', name: 'Alice Jhonson', image: Pim.wall, song: `Andrea Vanzo • Valzer d'Invento`, post: Pim.bracelets, username: '_username_', caption: 'Hey there!', comments: 'View all comments', uploadTime: '1 hour ago' },
            ...
            renderItem={({ item }) => (
                <View style={styles.post}>
                    <View style={{ flexDirection: 'row', marginBottom: 10, marginLeft: 10 }}>
                        <TouchableOpacity>
                            <Image source={item.image} style={{ height: 40, width: 40, borderRadius: 50, marginRight: 15 }} />
                        </TouchableOpacity>
                        <View style={{ flex: 0.96, }}>
                            <TouchableOpacity>
                                <Text style={{ fontSize: 20, color: 'white', margin: 1, fontFamily: 'Bold' }}>{item.name}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity>
                                <Ionicons
                                    name='musical-notes'
                                    color={'white'}
                                    size={12}><Text>{item.song}</Text>
                                </Ionicons>
                            </TouchableOpacity>
                        </View>
                        <TouchableOpacity>
                    ...
                    <View style={{ marginTop: 10, marginBottom: 5, flexDirection: 'row', marginLeft: 10 }}>
                        <TouchableOpacity onPress={toggleHeart}>
                            <Ionicons
                                ...
                                color={isHeartPressed ? 'red' : 'white'}
                                size={35}
                        ...
                        <TouchableOpacity onPress={toggleSave}>
                            <Ionicons
                                name={isSavePressed ? 'bookmark' : 'bookmark-outline'}
                                color={'white'}
                                size={30} />
                        </TouchableOpacity>
                    </View>
                    <Text style={{ color: 'white', fontSize: 18, fontFamily: 'Regular', marginLeft: 10 }}>Liked by <Text style={{ fontFamily: 'Bold' }}>{item.username}</Text> and others</Text>
                    <Text style={{ color: 'white', fontFamily: 'Regular', fontSize: 18, marginLeft: 10 }}><Text style={{ color: 'white', fontFamily: 'Bold' }}>{item.name} </Text>{item.caption}</Text>
                    <TouchableOpacity>
                        <Text style={{ color: '#aaa', fontSize: 18, fontFamily: 'Regular', marginLeft: 10 }}>{item.comments}</Text>
                    </TouchableOpacity>
                    <Text style={{ color: '#aaa', fontSize: 18, fontFamily: 'Regular', marginLeft: 10 }}>{item.uploadTime}</Text>
                </View>
            )}
